...
# en un unico artefacto: target/cyber-range-backend.jar sirve la API y la UI.
#
...
echo
echo "Listo: target/cyber-range-backend.jar"
echo "Arrancalo con: java -jar target/cyber-range-backend.jar"
