...
import com.hackdeck.domain.model.EventDetail;
import com.hackdeck.domain.model.FailureReason;
import com.hackdeck.domain.model.Game;
import com.hackdeck.domain.model.GameEvent;
import com.hackdeck.domain.model.GameEventType;
...
class NieblaDeGuerraTest {
    ...
    void las_defensas_del_rival_solo_se_ven_si_se_ha_pagado_por_averiguarlas() {
        ...
        partida.currentHalf().activate(
                com.hackdeck.domain.model.ActiveCard.permanent("mfa", Role.DEFENDER));
    ...
    void cada_bando_ve_solo_sus_propias_capas_activas() {
        Game partida = Partidas.enCurso();
        partida.currentHalf().activate(
                com.hackdeck.domain.model.ActiveCard.permanent("mi-defensa", Role.DEFENDER));
