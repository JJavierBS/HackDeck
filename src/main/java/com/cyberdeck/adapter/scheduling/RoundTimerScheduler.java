package com.cyberdeck.adapter.scheduling;

import com.cyberdeck.application.port.in.ResolveExpiredRoundsUseCase;
...
public class RoundTimerScheduler {
    ...
    @Scheduled(fixedDelayString = "${cyberdeck.round-timer.check-millis:1000}")
